...
2. **Copy the Module**:
   ...
   - Download the module as a ZIP from GitHub or clone it:
     ...
     ```bash
     git clone https://github.com/edgardorios/odoo-free-apps.git
     ```
...
![Ribbon banner displayed on a page](https://github.com/edgardorios/odoo-free-apps/raw/18.0/ribbon_banner/screenshots/banner.png)

![Configuration in General Settings](https://github.com/edgardorios/odoo-free-apps/raw/18.0/ribbon_banner/screenshots/settings.png)
...
For issues or feature requests, contact edgardo.rios@gmail.com or visit https://github.com/edgardorios/odoo-free-apps.
